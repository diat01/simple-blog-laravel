    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx">Blog Sitesi Admin</div>
            </a>
                ...
                <div id="collapseTwo" class="collapse @if(Request::segment(2) == 'makaleler') show @endif"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item @if(Request::segment(2) == 'makaleler' && Request::segment(3) == 'olustur') active @endif"
                            href="{{route('admin.makaleler.create')}}">Makale Olustur</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePage" class="collapse @if(Request::segment(2) == 'sayfalar') show @endif"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Sayfa Islemleri:</h6>
                        <a class="collapse-item @if(Request::segment(2) == 'sayfalar' && !Request::segment(3)) active @endif"
                            href="{{route('admin.page.index')}}">Tum Sayfalar</a>
                        <a class="collapse-item @if(Request::segment(2) == 'sayfalar' && Request::segment(3) == 'olustur') active @endif"
                            href="{{route('admin.page.create')}}">Sayfa Olustur</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('homepage')}}" target="_blank"
                            class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fa fa-globe fa-sm text-white-50"></i> Siteyi Goruntule</a>
                    </div>
